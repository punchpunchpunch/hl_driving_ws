...
class WaypointFollower(Node):
    ...
    def __init__(self):
        ...
        # load CSV waypoints
        # =====================
        file_dir = os.path.expanduser('~/ros2_ws/src/auto_car_test_pkg/auto_car_test_pkg/waypoints')
        # file_name = self.get_parameter('waypoint_csv').value
        # csv_path = os.path.join(file_dir, file_name)src/auto_car_test_pkg/auto_car_test_pkg/waypoints/waypoints_20260325_152509.csv
        csv_path = os.path.join(file_dir, 'waypoints_20260805_172828.csv') # waypoints csv 파일 이름
